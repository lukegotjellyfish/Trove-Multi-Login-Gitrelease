...
login_account(num) 
{
	if num = 1
		{
		ControlClick, x155 y253, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x155 y253, Inicio de sesión de Glyph   ;to make sure any text left behind is deleted
		Sleep, %normal_sleep%
		ControlClick, x155 y253, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		
		ControlSend,, %Email_One%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_One%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph ; Returing to Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2 ; Wait for menu to go away
		if ErrorLevel
		{
	...
	if num = 2
		{
		ControlSend,, %Email_Two%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Two%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2
		if ErrorLevel
		{
			Sleep, %wait_for_login%
		}
	...
	if num = 3
		{
		ControlSend,, %Email_Three%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Three%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2
		if ErrorLevel
	...
	if num = 4
		{
		ControlSend,, %Email_Four%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Four%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2
		if ErrorLevel
	...
	if num = 5
		{
		ControlSend,, %Email_Five%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Five%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2
		if ErrorLevel
	...
	if num = 6
		{
		ControlSend,, %Email_Six%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Six%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2
		if ErrorLevel
	...
	if num = 7
		{
		ControlSend,, %Email_Seven%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Seven%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2
		if ErrorLevel
	...
	if num = 8
		{
		ControlSend,, %Email_Eight%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Eight%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2
		if ErrorLevel
	...
	if num = 9
		{
		ControlSend,, %Email_Nine%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Nine%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2
		if ErrorLevel
	...
	if num = 10
		{
		ControlSend,, %Email_Ten%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Ten%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2
		if ErrorLevel
	...
	if num = 11
		{
		ControlSend,, %Email_Eleven%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Eleven%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2
		if ErrorLevel
	...
	if num = 12
		{
		ControlSend,, %Email_Twelve%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Twelve%, Inicio de sesión de Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Inicio de sesión de Glyph
		WinWaitNotActive, Inicio de sesión de Glyph,, 2
		if ErrorLevel
