...
login_account(num) 
{
	if num = 1
		{
		ControlClick, x155 y253, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x155 y253, Glyph 로그인   ;to make sure any text left behind is deleted
		Sleep, %normal_sleep%
		ControlClick, x155 y253, Glyph 로그인
		Sleep, %normal_sleep%
		
		ControlSend,, %Email_One%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_One%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인 ; Returing to Glyph
		WinWaitNotActive, Glyph 로그인,, 2 ; Wait for menu to go away
		if ErrorLevel
		{
	...
	if num = 2
		{
		ControlSend,, %Email_Two%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Two%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인
		WinWaitNotActive, Glyph 로그인,, 2
		if ErrorLevel
		{
			Sleep, %wait_for_login%
		}
	...
	if num = 3
		{
		ControlSend,, %Email_Three%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Three%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인
		WinWaitNotActive, Glyph 로그인,, 2
		if ErrorLevel
	...
	if num = 4
		{
		ControlSend,, %Email_Four%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Four%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인
		WinWaitNotActive, Glyph 로그인,, 2
		if ErrorLevel
	...
	if num = 5
		{
		ControlSend,, %Email_Five%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Five%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인
		WinWaitNotActive, Glyph 로그인,, 2
		if ErrorLevel
	...
	if num = 6
		{
		ControlSend,, %Email_Six%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Six%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인
		WinWaitNotActive, Glyph 로그인,, 2
		if ErrorLevel
	...
	if num = 7
		{
		ControlSend,, %Email_Seven%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Seven%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인
		WinWaitNotActive, Glyph 로그인,, 2
		if ErrorLevel
	...
	if num = 8
		{
		ControlSend,, %Email_Eight%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Eight%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인
		WinWaitNotActive, Glyph 로그인,, 2
		if ErrorLevel
	...
	if num = 9
		{
		ControlSend,, %Email_Nine%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Nine%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인
		WinWaitNotActive, Glyph 로그인,, 2
		if ErrorLevel
	...
	if num = 10
		{
		ControlSend,, %Email_Ten%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Ten%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인
		WinWaitNotActive, Glyph 로그인,, 2
		if ErrorLevel
	...
	if num = 11
		{
		ControlSend,, %Email_Eleven%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Eleven%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인
		WinWaitNotActive, Glyph 로그인,, 2
		if ErrorLevel
	...
	if num = 12
		{
		ControlSend,, %Email_Twelve%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Twelve%, Glyph 로그인
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Glyph 로그인
		WinWaitNotActive, Glyph 로그인,, 2
		if ErrorLevel
