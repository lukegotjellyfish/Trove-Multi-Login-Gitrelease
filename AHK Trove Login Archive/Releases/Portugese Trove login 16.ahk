...
login_account(num) 
{
	if num = 1
		{
		ControlClick, x155 y253, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x155 y253, Login da Glyph   ;to make sure any text left behind is deleted
		Sleep, %normal_sleep%
		ControlClick, x155 y253, Login da Glyph
		Sleep, %normal_sleep%
		
		ControlSend,, %Email_One%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_One%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph ; Returing to Glyph
		WinWaitNotActive, Login da Glyph,, 2 ; Wait for menu to go away
		if ErrorLevel
		{
	...
	if num = 2
		{
		ControlSend,, %Email_Two%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Two%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph
		WinWaitNotActive, Login da Glyph,, 2
		if ErrorLevel
		{
			Sleep, %wait_for_login%
		}
	...
	if num = 3
		{
		ControlSend,, %Email_Three%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Three%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph
		WinWaitNotActive, Login da Glyph,, 2
		if ErrorLevel
	...
	if num = 4
		{
		ControlSend,, %Email_Four%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Four%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph
		WinWaitNotActive, Login da Glyph,, 2
		if ErrorLevel
	...
	if num = 5
		{
		ControlSend,, %Email_Five%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Five%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph
		WinWaitNotActive, Login da Glyph,, 2
		if ErrorLevel
	...
	if num = 6
		{
		ControlSend,, %Email_Six%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Six%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph
		WinWaitNotActive, Login da Glyph,, 2
		if ErrorLevel
	...
	if num = 7
		{
		ControlSend,, %Email_Seven%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Seven%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph
		WinWaitNotActive, Login da Glyph,, 2
		if ErrorLevel
	...
	if num = 8
		{
		ControlSend,, %Email_Eight%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Eight%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph
		WinWaitNotActive, Login da Glyph,, 2
		if ErrorLevel
	...
	if num = 9
		{
		ControlSend,, %Email_Nine%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Nine%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph
		WinWaitNotActive, Login da Glyph,, 2
		if ErrorLevel
	...
	if num = 10
		{
		ControlSend,, %Email_Ten%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Ten%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph
		WinWaitNotActive, Login da Glyph,, 2
		if ErrorLevel
	...
	if num = 11
		{
		ControlSend,, %Email_Eleven%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Eleven%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph
		WinWaitNotActive, Login da Glyph,, 2
		if ErrorLevel
	...
	if num = 12
		{
		ControlSend,, %Email_Twelve%, Login da Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, Login da Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Twelve%, Login da Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, Login da Glyph
		WinWaitNotActive, Login da Glyph,, 2
		if ErrorLevel
