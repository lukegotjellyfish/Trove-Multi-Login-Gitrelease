...
login_account(num) 
{
	if num = 1
		{
		ControlClick, x155 y253, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x155 y253, 登录 Glyph   ;to make sure any text left behind is deleted
		Sleep, %normal_sleep%
		ControlClick, x155 y253, 登录 Glyph
		Sleep, %normal_sleep%
		
		ControlSend,, %Email_One%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_One%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph ; Returing to Glyph
		WinWaitNotActive, 登录 Glyph,, 2 ; Wait for menu to go away
		if ErrorLevel
		{
	...
	if num = 2
		{
		ControlSend,, %Email_Two%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Two%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph
		WinWaitNotActive, 登录 Glyph,, 2
		if ErrorLevel
		{
			Sleep, %wait_for_login%
		}
	...
	if num = 3
		{
		ControlSend,, %Email_Three%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Three%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph
		WinWaitNotActive, 登录 Glyph,, 2
		if ErrorLevel
	...
	if num = 4
		{
		ControlSend,, %Email_Four%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Four%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph
		WinWaitNotActive, 登录 Glyph,, 2
		if ErrorLevel
	...
	if num = 5
		{
		ControlSend,, %Email_Five%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Five%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph
		WinWaitNotActive, 登录 Glyph,, 2
		if ErrorLevel
	...
	if num = 6
		{
		ControlSend,, %Email_Six%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Six%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph
		WinWaitNotActive, 登录 Glyph,, 2
		if ErrorLevel
	...
	if num = 7
		{
		ControlSend,, %Email_Seven%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Seven%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph
		WinWaitNotActive, 登录 Glyph,, 2
		if ErrorLevel
	...
	if num = 8
		{
		ControlSend,, %Email_Eight%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Eight%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph
		WinWaitNotActive, 登录 Glyph,, 2
		if ErrorLevel
	...
	if num = 9
		{
		ControlSend,, %Email_Nine%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Nine%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph
		WinWaitNotActive, 登录 Glyph,, 2
		if ErrorLevel
	...
	if num = 10
		{
		ControlSend,, %Email_Ten%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Ten%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph
		WinWaitNotActive, 登录 Glyph,, 2
		if ErrorLevel
	...
	if num = 11
		{
		ControlSend,, %Email_Eleven%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Eleven%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph
		WinWaitNotActive, 登录 Glyph,, 2
		if ErrorLevel
	...
	if num = 12
		{
		ControlSend,, %Email_Twelve%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlClick, x147 y322, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSendRaw,, %Password_Twelve%, 登录 Glyph
		Sleep, %normal_sleep%
		ControlSend,, {enter down}{enter up}, 登录 Glyph
		WinWaitNotActive, 登录 Glyph,, 2
		if ErrorLevel
